...
INSERT INTO `category` (`name`) VALUES ('Classics'),('Fantasy'),('Mystery'),('Romance'),('Sci-fi'),('Cooking'),('Travel'),('Self-help');
...
INSERT INTO `book` (title, author, description, price, rating, is_public, is_featured, category_id)
VALUES ('The Structure of Scientific Revolutions', 'Thomas S. Kuhn', 'The history of scientific paradigms', 11.99, 4.4, TRUE, FALSE, 1008);